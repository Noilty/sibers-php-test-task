            ...
            <div class="row no-gutters">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <p class="card-text">Birthday: <strong><?= date('Y-m-d', $userData['birthday']) ?></strong></p>
                        <p class="card-text">
                            <small class="text-muted">Registration date: <strong><?= date('Y-m-d', $userData['reg_date']) ?></strong></small>
                        </p>
                    </div>
                </div>
            </div>
